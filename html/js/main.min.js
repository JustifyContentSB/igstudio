...
"use strict";function reviewsSlider(){new Swiper(".reviews__slider",{slidesPerView:1,slidesPerGroup:1,spaceBetween:10,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},pagination:{clickable:!0,el:".reviews__pagination"},breakpoints:{768:{slidesPerView:2,slidesPerGroup:2,spaceBetween:20},900:{slidesPerView:3,slidesPerGroup:3,spaceBetween:30}}})}function featuresSider(){$(window).width()<900&&new Swiper(".features__slider",{spaceBetween:30,pagination:{clickable:!0,el:".features__pagination"}})}function teamSider(){$(window).width()<=500&&new Swiper(".team__slider",{spaceBetween:30,pagination:{clickable:!0,el:".team__pagination"}})}function menuShow(){$(window).width()<=1200&&$(".header__burger").on("click",function(e){e.preventDefault(),$(".header__burger").toggleClass("header__burger--active"),$(".header__nav").toggleClass("header__nav--active")})}function faqShow(){$(".faq__answer:first").show(),$(".faq__manage:first").addClass("faq__manage--active"),$(".faq__manage").on("click",function(){var e=$(this).next();$(".faq__answer").not(e).slideUp(400),$(".faq__manage").not(this).removeClass("faq__manage--active"),$(this).toggleClass("faq__manage--active"),e.slideToggle(400)})}function animScroll(){for(var e=new ScrollMagic.Controller,a=document.getElementsByClassName("anim-item"),i=0;i<a.length;i++)new ScrollMagic.Scene({triggerElement:a[i],offset:50,triggerHook:.9}).setClassToggle(a[i],"visible").addTo(e)}$(document).ready(function(){reviewsSlider(),faqShow(),featuresSider(),teamSider(),menuShow(),animScroll()});